...
?>
    ...
    <div id="top"> 
        <ul>
            ...
            <li id="cajapadre">
                    <img src="imagenes/conter.jpg" alt="equis de" class="imagenRecomendadaimg">
                    <div id="contenedor">
                    <div id="contenedorsuperior"></div>
                    <div id="contenedorinferior">
                    <span><strong>COUNTER STRIKE GO</strong></span>
                    </div>
                    </div>
            </li>
            <li id="cajapadre">
    ...
    <section>
        ...
        <article>
            <div class="content">
                <img src="../Infinity/imagenes/war1.jpg" alt="SPAe">
            </div>
        </article>
